    ...
    return (
        <div className="bg-white -mt-24">
            ...
            <main className="isolate">
                            ...
                            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                                        We’re changing the way teams <span className="text-secondary">connect</span>
                                    </h1>
                                    <div className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                        <p>                  Effective communication is vital in newly formed teams, where members are still learning to work together seamlessly. Sork was built to allow for the following:
                                        </p>

                                        <ul className='list-disc pl-12 mt-4'>
                                            <li>
                                                <span className='font-bold'>Structured Conversations:</span> Threaded messaging for organized discussions
                                            </li>

                                            <li><span className='font-bold'>Integration:</span> Easy connection with essential business tools</li>
                                            <li><span className='font-bold'>Robust Voice and Video Calls:</span> Crystal-clear communication options</li>
                                        </ul>


                                        <p className='mt-4'>With Sork, every team member stays connected and productive, fostering successful collaboration and team dynamics.</p>
                ...
                {/* Content section */}
                <div className="hidden mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
                ...
                {/* Image section */}
                <div className="hidden mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
                    <img
                ...
                {/* TEAM section */}
                <div className=" hidden mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            {/* Footer */}
            <footer className="hidden mx-auto mt-40 max-w-7xl overflow-hidden px-6 pb-20 sm:mt-64 sm:pb-24 lg:px-8">
                ...
                <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                    &copy; 2024 Sork All rights reserved.
                </p>
            </footer>
        </div>
    )
