          ...
          <div className='col-span-9 pr-10'>
              ...
              <div className="chat-image avatar">
                <div className="w-10 rounded-full">
                  <img alt="Tailwind CSS chat bubble component"
                       src="https://firebasestorage.googleapis.com/v0/b/cyberjags-8b081.appspot.com/o/no%40ctfguide.com%2Fpictures%2Fpfp?alt=media&token=a573b854-7691-4611-aacb-0f0456a485bb"/>
                </div>
              </div>
            ...
            <div className="chat chat-start mt-4">
              <div className="chat-image avatar">
                <div className="w-10 rounded-full">
                  <img alt="Tailwind CSS chat bubble component"
                       src="https://firebasestorage.googleapis.com/v0/b/cyberjags-8b081.appspot.com/o/kshitij%40ctfguide.com%2Fpictures%2Fpfp?alt=media&token=9a9c7280-a7d7-4670-8aee-b59f26b779c4"/>
                </div>
              </div>
              <div className="chat-header">
                kshitij
              ...
              <div className="chat-bubble">whats goody my gang?</div>
              <div className="chat-footer opacity-50">
                Delivered
              </div>
            </div>
