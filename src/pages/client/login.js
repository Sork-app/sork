    ...
    async function logIn() {
        ...
        if (error) {
            ...
            if (data) {
                ...
                await router.push('/client/workspaces')
            }
        }
    }
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        autoComplete="email"
                                        required
                                        className="block text-white bg-base-100 border-none w-full border-0 py-1.5 shadow-sm ring-none sm:text-sm sm:leading-6 px-2"
                                    />
                                </div>
                            </div>
                        ...
                        <div className='hidden'>
                            <div className="relative mt-10">
                                ...
                                <div className="relative flex justify-center text-sm font-medium leading-6">
                                    <span className="bg-base-200 px-6 text-white">Or continue with</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-4">
                                ...
                                <a
                                    href="#"
                                    className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm ring-1 ring-inset ring-gray-300  focus-visible:ring-transparent"
                                >
